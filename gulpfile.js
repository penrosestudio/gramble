...
gulp.task('javascripts', function() {
  gulp.src(['./src/javascripts/jquery-1.11.0.min.js', './src/javascripts/bootstrap.min.js', './src/javascripts/packery.pkgd.js', './src/javascripts/imagesloaded.pkgd.js', './src/javascripts/app.js'])
    .pipe(concat('main.js'))
